...
data_db = [
    ...
    {'id': 2, 'title': 'Роберт покоряет горы',
     'content': '''Это история про очень смышленого и храброго пса, который осмелился покорить северный Тянь-Шань. 
     <br>Сегодня он отдыхает дома, а завтра взбирается на горные пики...''', 'is_published': True},
    {'id': 3, 'title': 'Выносливость породы', 'content': 'Сегодня поговорим о том, что на самом деле скрывается за '
    'милой мордочкой вашего питомца. Это может быть лев или тигр, а может быть бурый медведь', 'is_published': True},
    {'id': 4, 'title': 'Преводсходство собак над кошками', 'content': 'На самом деле все относительно. Нельзя '
    'сказать, что собаки лучше кошек, и наоборот. Плюсы есть и у того вида животных, и у другого', 'is_published': True},
